...
## [2026-08-25] ingest | held-queue batch 15 — the final 13 long-body posts (2005-06-06, 2005-07-07, 2005-07-19, 2005-09-01, 2006-02-13, 2006-03-06, 2006-05-25, 2007-07-08, 2007-12-03, 2009-02-02, 2015-09-20, 2016-03-27, 2018-01-01). **The long-body tier is fully ingested — 75/75 — and the held queue is now 349 single-marker posts.** **A diagnostic completed.** The wiki carried two corners of his news-reaction test (leaders sold off on good earnings = warning; leaders surging on good earnings = strength). The fourth corner arrives on the day of the London bombings: "**who would ever have believed that a market in a confirmed down trend could withstand a terrorist attack and actually hold its own?… if stocks were going to decline more near term, I think the market had the perfect excuse to do so today — and it did not**" (2005-07-07), stated as doctrine six weeks later during Katrina — "**declines do not begin when the news headlines shriek of calamity**." Filed as a 2×2 on `risk-and-cash.md`: the news supplies the occasion, price supplies the information. **A chart used to falsify a causal story** — the best instance of his price-first epistemics, and an argument entirely about dates. Against the press attributing a bond rally to Katrina: "**long term bonds were rising, and rates were falling, since August 9, long before the hurricane. Unless we believe that prescient traders foresaw the hurricane debacle weeks before it hit, we must conclude that the economy was weakening… and that Katrina's damage merely intensified the pre-existing trend**," corroborated across SHY, IEF and TLT. If the move began before the cause, the cause is not the cause — and the conclusion is deliberately modest (*intensified*, not *created*). This also **re-dates TLT to September 2005**, a decade before the 2016 post the wiki credited, with the stage test run on the 20+ year Treasury index by March 2006. **A housing top called in March 2006** with a chart, a level and a hedge: "a close below 1705 would indicate a major top… **if housing goes, what will happen to the rest of the economy?**" — the technical call specific, the macro consequence posed as a question. Filed on `track-record.md` eighteen months ahead of the crisis posts. **How he resolves conflicting indicators**, from a December 2007 ledger with both cases itemised and numbered: "**the most sensitive indicators are starting to turn up, but the relatively longer term trend indicators are still declining. Statistically, this is how turnarounds must unfold. The prudent thing to do is to wait a little longer.**" Fast-before-slow is necessary but not sufficient — every genuine bottom looks like this and so does every failed bounce — so the pattern alone carries no signal. Now on the market-state playbook. Also: **IBD 100 lists decay measurably with age** (62–71% of the two newest lists within 5% of their highs against a third or less for lists four months older), yielding the only rule any of his audits produced — "**stay mainly with those on the more recent lists**"; **the "% in a strong rise" row defined** on the day it was added (four consecutive closes above the 10-day average, 2006-02-13) and put on trial in public rather than asserted; **GMI-R's design purpose** — "shorter term indicators that can detect a change in trend earlier," which is why it and the GMI diverge at turns by construction; **why component 1 can stay pinned negative for months** (fewer than 20 new highs a day, so the 2008 floor speaks rather than the follow-through rate); **the low-side mirror at its documented extreme**, above 70% for four days in February 2009; **Stage 4 with both its conditions** and missed upside priced as a premium — "**that is the cost of my insurance against a huge loss… only a stock addict thinks s/he must always be in the game**"; **the GLB's hit rate as a regime variable** — "few GLBs have turned out this well recently. It is very important to sell a GLB stock quickly if it does not behave like TFX"; **red lines versus blue lines as two different warnings** on the daily RWB chart (a pause versus a trend problem), which is why the RLC is a caution counter at index level; **three sentiment samples he takes from his own life** — reader mail, peers reporting profits, meetup attendance — none of which generates a trade alone; **why the sell stops exist** ("**provide me the ability to focus on my job during the day and to sleep peacefully at night**"), a design constraint the whole method inherits; and the flattest ego statement in the corpus, written mid-reversal: "**the idea is to make \$\$, not to be right. A big ego is lethal in this business — in all business**," with the view reversing at once and the position still waiting for a definite GMI signal. One schema note: 2005-06-06 was tiered `daily_update` and its draft source page deleted — per CLAUDE.md §4, daily updates carry a summary but no page. Ledger 4,332 → 4,345.

## [2026-08-26] ingest | single-marker tail, batch 1 — 7 posts (2005-06-16, 2007-10-16, 2009-10-12, 2010-07-30, 2014-03-23, 2017-12-10, 2018-10-28). First batch of the 349-post single-marker tail, worked by picking the *rarest* markers first (`formula`, `i created a column`, `i have revised`, `i define`, `criteria are`) on the theory that definitional language is where the remaining specifications hide. It was: five of the seven carry a definition the wiki did not have. **A dating error corrected.** The glossary said the GMI-R was "used between 2005 and 2011." It was **introduced on 2007-10-16** — the first appearance of the term anywhere in the corpus, in the post that announces it: "I have revised the GMI by adding 4 new indicators, signified by an '*'. The GMI-R ranges from 0-10 and **may provide a more sensitive measure** of the trend of the general market. For the time being, I will post the original GMI and the revised GMI-R in the table **for the benefit of readers who use the original index**." Three design facts in one sentence — asterisked in the table, aimed at sensitivity, and run in parallel as a *compatibility decision for readers* rather than an analytical one. `gmi-family.md` already had 2007–2011; the glossary is now consistent with it. **The sell side of the daily RWB chart, fully specified** (2017-12-10), which the wiki had only in fragments. All 13 exponential averages listed (1, 3, 5, 8, 10, 12, 15, 30, 35, 40, 45, 50, 60), with the "1" identified as the **gray dotted line representing the daily close** — and it is the line that triggers: "**when the gray line *closes* below all of the red lines it is a sign of weakness and I consider selling or lightening up**… **I try not to sell a stock when the gray dotted line is holding up**," which is an explicit rule *against* exiting on band compression alone. The exit is **graded** and now tabulated on the exits playbook: reduce or raise stops on the close below the red lines (preferably two consecutive), sell the whole position only when the RWB pattern itself disappears. The same post **derives the 3:45 PM rule** rather than merely asserting it — signals are defined on closes because stocks "often trade below the red lines during the day but recover to close back above them," so "**I therefore like to trade near the market's close**." **The duration study with its sample size and a caveat he wrote himself**: "41% of the **51** down-trends between 2006 and December 2013 (**as I define them**) lasted 5 days or less." Both qualifications matter and both are now on the page — n = 51 over eight years is small, and the base rate is conditional on his own trend definition, so it does not transfer to another timing rule. **The dual-timeframe RWB column filter** (RWB required on the daily *and* weekly charts) with its yield as a market reading: 62 of 4,938 US stocks (1.3%) and **0 of 38 country ETFs** in October 2018 — plus a T2108 base rate worth having, "from its inception in 1986 to 2007, T2108 had **only 7 other declines that reached below 10%**," which is what makes that level actionable rather than merely low. Also: **his own statement of purpose and method** (2010-07-30) — "**I do not predict the length of trends, I try only to ride them until they end**"; a research psychologist and part-time trader teaching at Maryland, writing because "our education system has failed to prepare its citizens for their financial survival"; and a publishing habit that explains the corpus's shape — **the full GMI component table appears only on Mondays**, which compounds the image problem noted on `gmi-evidence.md`. **An audit built to test a criticism** (2009-10-12): "too late by the time it reaches the top of the list" checked against two separately published IBD 100 lists, 70% of the top ten beating QQQQ and SPY both times — with the path dependence reported, the conclusion kept weak, and TYH's +25% over the same window printed alongside, undercutting the exercise. That post also carries the nearest thing in the corpus to a justification for technical analysis, and it is a claim about people: "**because human trading psychology is pretty stable, one can discern lasting technical patterns (which are really trading decisions)**." And **a pedagogical device worth recording**: his students trade virtual $100,000 accounts and **must stay 90% invested**, so that they learn regime-dependence expensively — "I did teach them that these set-ups only work in rising markets, and they are learning this valuable lesson," a caveat he then applies to his own filter. Ledger 4,345 → 4,352; held 349 → 342. **Method note for the next batches:** the rare-marker-first ordering worked well and there are ~32 definitional-marker posts left; after those the tail is dominated by `remember,` (46), `the key is` (46) and `i prefer` (30), which are likelier to be restatement than definition.

## [2026-08-26] ingest | single-marker tail, batch 2 — 8 posts (2005-08-19, 2008-02-25, 2008-03-10, 2009-12-21, 2010-08-02, 2011-08-22, 2014-12-17, 2021-11-23). **The largest piece of original research in the corpus.** August 2011, run to settle an argument he was tired of hearing: "I decided to look at the long multi-week declines of the **Dow 30 Index since 1916. I computed the duration and depth of every multi-week decline** that has occurred. **I defined a multi-week decline as one when the Dow declined at least 15% in a few weeks without a consolidation along the way**… **My calculations were quick and dirty so do not hold me to them exactly. They still paint a valid picture.**" Findings: **33** such declines; **30 of the 33 deeper than 15%**; four precedents for a 4-week ≥15% fall (1916, 1931, 1987, 2001). What it refutes is the claim that 2011 was unique because of high-frequency trading — "**how many of these declines that occurred before the PC can we blame on program trading!**" — which is the same argument that underwrites why patterns repeat at all. Note the epistemic care on both sides: the definition his count depends on is published, the arithmetic is flagged as rough, and the conclusion is a probability shift rather than a forecast. Filed on `trading-philosophy.md` beside the 51-down-trend study, which carries the same "as I define them" discipline. **Why commodities are the exception to buying all-time highs** — a boundary on his central rule, justified by a difference in kind: "**I usually only buy stocks at all-time highs. Commodities are different, however, because they have a true value. Natural gas is not likely to go to zero. I therefore think that commodities go back and forth between oversold and overbought.**" A stock has no price floor, so you follow the trend; a commodity has use value, so you trade the oscillation. That is the same test that governs [I-bonds] and dollar-cost-averaging into funds but never single names — in each case, can the instrument go to zero. **The stop belongs to the trade, not the stock**: publishing a rocket table with **both** a short- and long-term support level per name, he explains the choice — "the most conservative stop loss is the short term support level… **however, if I bought near long term support I might use the LT support level as my exit strategy**." Buy near long-term support and you have bought the room to use it. And the protection is immediate — "I immediately enter a sell stop or buy a put option for insurance, after buying one of these high momentum stocks." **A submarine trade specified end to end** (2008): the entry is the **failed retest of the 30-week from below** with the 10-week already beneath it — not the initial break — expressed as a put in the IRA with the invalidation priced at a specific number. Also: **the naked chart** (10- and 30-day averages plotted with price removed, so the trend reduces to which line is on top) and the rule it produced, with two qualifiers that matter — *consistently* below, and *especially after a long period above*, so the best short candidates are former leaders; **T2108's bottom band built from named cases** (~14% typical, 18% at the January 2008 low, under 1% in 1987) — the reasoning that later hardens into the below-10% level; **both halves of the Day-5 rule** — "once one passes 5 days, it often goes a lot further," which is what makes it an *accumulation* trigger and not merely a filter; **the pension constraint in one sentence** — "if I could frequently trade my mutual funds in my university pension, I would have transferred some money to money market funds," so some of the two-speed patience is imposed rather than chosen; **nibbling defined as a mode** (small size, close stops, only names at new highs against the tape) with a **buy-write** overlay that appears nowhere else — rich premiums in a frightened market paying for part of the risk it imposes; **SHY named as the short-rate proxy**, read with the same daily GMMA language as a stock, with Zweig and Ned Davis cited for don't-fight-the-Fed and the mechanism stated (competing risk-free yield); and a small act of self-correction the day after the November 2021 top — "**I regret that I changed the word *scared* to *concerned* in yesterday's post**." **Tooling:** timeline insertion now resolves position by *date* rather than by a hand-picked anchor heading (`scratchpad/tl.py`), and wires the page's Sources block itself. Anchor-not-found was the failure that broke nearly every previous batch; batches can now be larger safely. Ledger 4,352 → 4,360; held 342 → 334.

## [2026-08-26] ingest | single-marker tail, batch 3 — 9 posts (2008-10-28, 2009-01-20, 2010-11-26, 2011-03-04, 2011-03-10, 2011-09-26, 2014-05-07, 2019-06-16, 2025-05-05). **Component 1's rationale finally has an author.** The 2005 statement credits "the gurus cited in the books to the right"; October 2008 names him — "**Nicolas Darvas wrote that a pattern of failed break-outs often tipped him off to a coming bear market**" — and derives the unpublished low-side twin from the same sentence by symmetry: "**well, the reverse is true in a declining market. In a declining market stocks hitting new lows should continue to decline. So, I compute each night a similar measure.**" The mirror is then *measured* across the collapse rather than described: from 8 September, "with one exception… each day 50% or more" of stocks at new lows ten days earlier closed lower, "**the percentages were above 80% on many of the days**." **How an RWB up-trend begins — the exact mirror of the top sequence.** The 2018 post gave the top's ordered stages; June 2019 gives the onset's: "**the beginning of a daily RWB up-trend starts with the closing price rising above all 12 averages. Next the red lines climb above the blue lines**," then the white space opens. Both are now tabulated side by side on `gmma-charts.md`, along with the maintenance signature ("during most of an RWB rise, the closing price leads all of the averages higher") and the failure condition. Stage 1 is common and stage 3 is rare in both directions — the same asymmetry. **The leader watchlist, named.** Every "the leaders are weakening" statement in the corpus rested on an unstated list; readers asked and he answered: "**PCLN, AZO, AAPL, BIDU, CMG, AMZN, GOOG, NFLX, FFIV**," scored on the ordinary 10-week test — "the last 4 are showing weakness, closing below their 10 week averages." So the phrase means a countable fraction of a named list, treated as one input among several. **A regime condition the income strategies were missing.** After a losing month: "**selling puts is equivalent to buying stocks and selling call options on the shares. I learned again the lesson not to sell puts or covered calls during a weak or declining market.**" Both overlays are long-delta; the premium reduces a loss slightly and caps the recovery. The 2007 covered-call and 2014 GLD-weeklies material read as unconditional without this. **A structural explanation for index divergence**, which the wiki had only as an observation: "**the Nasdaq 100 Index (QQQ), unlike the S&P500 Index (SPY), contains no financial stocks**" — so a QQQ/SPY split is sometimes a *composition* fact, and the GMI's tech weighting is structurally blind to a financials-led decline. Also: **"I only buy stocks that have monthly, weekly AND daily up-trends in place"** — the three-chart procedure as a conjunction; **the lower Bollinger Band preferred to a hand-drawn trend line** when the two coincide, with the bounce's target bounded at the upper band and the pinch directionless by construction; **"while my objective criteria for a short term down-trend have been met, I do not trust it"** — signal and confidence tracked as separate quantities, resolved by the Day-5 rule rather than by overriding either; **the ATH-list workflow** (sort by close/close-250-days-ago with a ≥50% floor, read the industry column for clusters, look for GLBs, check earnings dates), with GMCR after 2008 as the archetype; **support projected forward from a rising 30-week average** as a number ($154 on GLD); and **three lessons he says he has to relearn** — wait for the signal, use the slower chart, don't sell options into weakness — which are collected on `trading-psychology.md`, since a rule you relearn is one your instincts keep overriding. Ledger 4,360 → 4,369; held 334 → 325.

## [2026-08-26] ingest | single-marker tail, batch 4 — 81 posts read (25% of the remaining queue), **27 tiered `teaching` with source pages, 54 tiered `daily_update`**. Method note first, because it matters for how this batch should be read: the long-body and definitional-marker tiers were high-yield because their screens selected for teaching content. This tail is dominated by `remember,` / `the key is` / `i prefer`, which catch restatement as often as doctrine — so all 81 were read, and only the ones carrying something new got a page. The other 54 are routine market notes that corroborate documented doctrine without adding a rule; each carries a `[read in the 2026-08-26 tail sweep]` summary saying so. Writing 81 source pages would have been padding. **The most rigorous thing in the corpus turns out to be a replication.** October 2016: "I updated my analysis from 2013 of how long QQQ short term trends last. **The findings are remarkably similar.**" The distribution — **41% of down-trends vs 21% of up-trends end within 5 days; 63%/56% run 6–47 days; up-trends are 5× likelier (16% vs 3%) to reach 50+ days** — is now a table on `qqq-short-term-timing.md`, with the asymmetry identified as the finding that justifies asymmetric tactics. Three caveats travel with it, all his own: the trend definition is **deliberately unpublished** ("proprietary, so don't ask for it" — the standing caveat on every duration figure here); the table **understates persistence** because brief counter-moves split one long move into several; and age is best asked **conditionally** ("of the 11 up-trends that lasted 50 to 88 days, 45% ended by day 54"). The long-side central range comes from a separate 2006–2013 analysis: "**the majority go on from 11-44 days**." **The COVID top was flagged by a crossover, not a level.** The nightly spreadsheet's first two columns are the mirror indicators, and "**note that on February 21, the two indicators were equal at 55%**" — the high-side follow-through falling to meet the low-side, on the last session before the fastest bear market on record. The wiki had these as two separate series; their convergence is a third reading. Darvas is named again as the reason the calculation exists. **The GMI Sell audited by regime.** Not "it whipsaws" but: the September 2008 Sell "kept me out of the markets during most of the subsequent huge market decline," while since then "**a Sell signal has often come at the bottom of a small decline**." It works at the onset of a bear and misfires inside corrections — and **the two cases are indistinguishable when it fires**, which is a sharper statement of the limitation than the February 2015 demotion. **The rate thesis is a loop, not a warning.** April 2023: "I told you in November, 2021 that I was exiting… **now get ready for the reverse**… **the Fed tightens too much and then slashes rates to get the economy going again**." The same mechanism produced the exit and the re-entry seventeen months later, executed across both accounts, with the entry rule unchanged by eighteen months in cash. The arithmetic underneath it is taught explicitly in 2014 with a worked example (a $100 bond paying $3 is worth ~$50 when new bonds pay 6%) — which is why TLT, IEF and SHY *are* the rate view rather than proxies for it. Also: **the 8% loss limit and never averaging down** stated in 2005 by rejecting Cramer's trader/investor distinction, with an *informational* argument (outsiders learn last, so a falling price is not a discount); **how bear markets end** — large caps first, speculative names only after buyers have profits, which is why growth screens stay empty after a genuine turn; **"a rising tide raises all ships"**, two years of gains attributed to beta about himself and his readers together; **the QQQ blind spot priced** at a missed 22–23% a year before the post the wiki credits; **readers challenging him for overriding his own indicators in 2006 — and his concession** ("you may be right — maybe I should fly on instruments"); **why a moving average turning down is arithmetic rather than shape** (this week's price below the price 31 weeks ago); **T2108 below 10% lasts one or two weeks at most**, which bounds the accumulation window; **a weak *peak* in T2108 as its own warning**; **the Bollinger 95% rationale** with the breakout exception that stops it contradicting the GLB; **the GMMA drawn with prices rendered invisible** — the 2005 naked chart, fifteen years on, and the reason every RWB rule is phrased as close-versus-averages; **sector ETFs as the retirement-age instrument** with the scan published; **the Investors Intelligence 60%-bulls top threshold**; **two personal top tells** (his own account rising fast; other people reporting profits); and **the blog's first post**, where Darvas's biography carries the argument that distance is a precondition for judgement — "I want a life, too," which is load-bearing: a method for someone with a full-time job has to be checkable once a day. Ledger 4,369 → 4,450; **held 325 → 244**. Tooling note: `tl.py` (date-resolved timeline insertion) made a batch this size practical — no anchor lookups, no per-post hand-placement.

## [2026-08-26] ingest | single-marker tail, batch 5 — another 81 posts read, **24 tiered `teaching` with source pages, 57 tiered `daily_update`**. Same method as the previous chunk: read everything, page only what teaches. The teaching rate held at roughly 30%, which suggests the tail is not yet exhausted. **The only independent test of the GMI in the corpus.** November 2013: "**The Dark Liquidity site** has been comparing the GMI based trading strategy versus a number of other strategies. For each of the last two years **a strategy that bought the QLD whenever the GMI signaled buy, and went to cash every time it signaled sell, beat all other strategies followed. In 2012 the GMI based QLD strategy was up about +30% and thus far in 2013 it is up +42%.**" Every other audit on `gmi-evidence.md` is his own. He reports the favourable outside result *and* discloses that he has not audited it — "**I do not check that site's computations**" — which is the part worth keeping. Note also what was tested: leveraged long on Buy, **cash** on Sell, never short. **A survivorship critique of the entire pattern-book genre**, aimed at books he otherwise draws on: "**model books of rising stocks can be very misleading because, by definition, most set-ups worked for these winners. With these model stocks that rise for months one could just buy every Monday or every x day and make money. There is nothing special about the set-ups. The authors never tell you how often the highlighted set-ups can fail.**" A book of winners selects on the outcome, so every entry rule looks good inside it — including deliberately arbitrary ones. The criticism applies to his own GLB Tracker, which he elsewhere admits is a survivor list, and he answers it in the same post by publishing a failure (CALM) beside the rule. Filed on `trading-philosophy.md` with links to the three places this wiki already states a failure rate. **The caveat that belongs with every ultra-ETF figure on the wiki.** 2012: "the easiest way to ride an up market is to buy one of these leveraged ETF's when the GMI flashes a buy signal. **Of course, I never have the courage to do it right away when it is most scary. I tend to slowly accumulate one of the leveraged ETF's as the up-trend persists.**" The recommended strategy and the executed one differ, he is the one who says so, and the quoted returns all assume a day-1 entry he admits he does not make. Now attached to the measurements rather than left implicit. **Two re-datings.** The **mirror statistic** moves again — to **2005-04-25**, the blog's ninth day, alongside a *published range* for the high-side index (8–106 since March 2005), the earliest calibration of any indicator here. And **I-bonds** move from 2014 to **2005** ("I wrote a piece about I-bonds several months ago"), making them a standing preference rather than a response to one rate cycle. **The market gate is autobiographical**: "**when I began trading in the 60s… I would make money when the market moved up and then lose the profits and more when the market receded**" until Darvas and O'Neil explained why. Also: **95 short-term up-trends since 2006** — the denominator behind every duration percentage — with the longest (91 days) ending **2020-02-24**, the COVID top, the same week the new-high/new-low crossover flagged it from a different instrument; **persistence existed at *component* level in 2007**, four years before the two-day signal rule, so 2011 generalised an existing discipline rather than inventing one; **the GMI cannot mark a bottom and he says so** — "it typically turns Green several days after a bottom is in," while the put/call ratio and T2108 "did signal the bottom on the day it was reached"; **the blue dot defined** (daily 10.4 oversold stochastic climbing back above 20); **the WGB in plain language** — a *weekly shakeout that failed* — and its scan with all seven conditions, including relative strength vs SPY at a 20-week high; **the weekly recovery sequence** (close above the 4-week → 4wk>10wk → 10wk>30wk) and the gap-close that produces the bounce *not* to buy; **GMMA charts applied to mutual funds**, which is how the pension's actual holdings get timed rather than only its benchmark; **the AAPL GLB worked end to end with dates**, thirteen months from line to signal; **an execution failure admitted in full** ("I need to let my computer trade for me"); **Judy documented** as the concept-stock collaborator who supplies thesis where he supplies timing; and **forty investors, none of whom would buy a stock at a new high** — the behavioural gap measured rather than assumed. Ledger 4,450 → 4,531; **held 244 → 163**.

## [2026-08-26] ingest | single-marker tail, batch 6 — another 81 posts read, **12 tiered `teaching`, 69 tiered `daily_update`**. **The teaching rate dropped from ~30% to 15%**, which is the expected shape: this chunk spans 180 → 107 words per post, and short daily notes mostly restate the trend count, the breadth stats and the wait-for-the-signal discipline. Recording the drop because it is the signal that the tail is thinning — the next chunk should be lower still. **The intraday near-ATH scan, with its formula.** The 2018 condition set finds stocks *at* an all-time high during the session; this one finds them *near* one: "a simple formula I wrote for TC2000 that **finds any stock that reaches an ATH in the past 100 days** (price new high built-in condition set to **250 month high within past 5 months**) **and that is currently within 3% of its 100 day high (`C>.97*maxh100`)**. TC2000 scans my watchlist of IBD50/MarketSmith stocks **real time throughout the day**." Two conditions with distinct jobs — one establishes a genuine all-time high in recent history, the other keeps the stock near it, which is the proximity filter that puts an entry close to its invalidation. What stays manual is the judgement: volume buzz, then fundamentals, by hand. **Why the pilot buy works**, which the wiki had as a rule without its argument: "**in this way I have the greatest position (and risk) only after the movement is consistent with my initial purchases**." Pyramiding is not about improving an average price — it arranges for the largest exposure to exist only when the thesis has the most evidence behind it. The pilot buy and the close stop are presented as **one** rule, not two. **A setup's failure rate, measured — 8%.** "With the GMI at 1, 6x more new 52 week lows than new highs, and **only 8% of recent bounce on support set-ups working**, I am on the side-lines." That is his own primary bounce entry failing more than nine times in ten in a weak tape — the missing denominator his own [model-book critique] says the pattern literature never supplies, produced about his own method. He also reads it as a *market* indicator: when setups stop working, that is evidence about the tape. Also: **a fourth observable crowd** — he polls his students and treats the series as contrarian ("80% bullish… the highest reading this semester"), with the honest note that the reading probably moved *because his own GMI turned Green*, so the sentiment he is fading is partly his own signal propagating; **the Investors Intelligence bottom anchor** (under 30% bulls at the September 2010 low) used *prospectively* rather than in hindsight, completing a gauge the wiki had only at its top end; **the TQQQ caveat in his own words** — "**it also falls 3x faster than QQQ and one must have solid rules for exiting**" — which places the instrument downstream of the trend count rather than in place of it, plus the ego line ("if we are in it to make money rather than satisfying our egos"); **what to do when you miss a GLB** ("buy after a bounce up off of the 10 week or 4wk average") — a Stage 2 stock keeps generating entries, so a missed alert costs the best price rather than the trade; **the Blue Dot of Happiness setup** justified from the exit rather than the gain, with the caveat that a morning dot can fail by the close; **"the market discounts the future"** as the mechanism that explains price moving against the news without appealing to irrationality; **the 10-week/30-week split in one sentence** ("below its 10 week average I become defensive… below its 30 week average I begin to exit"); **the Bollinger bands used to name prices in advance** on index ETFs, with the qualification that a touch reverts but a decisive break does not; and **August 2006 as where the leveraged-ETF thread begins**, with the 2× ProShares funds introduced to readers as a novelty two months before he first measured them. Ledger 4,531 → 4,612; **held 163 → 82**.
