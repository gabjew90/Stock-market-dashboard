---
title: Defensive episodes, worked — 2010, 2011, 2015, 2018, 2022
type: history
updated: 2026-08-18
sources:
...
Six occasions on which the blog shows the defensive doctrine being *applied* rather than stated — what the indicators read, what he did, and what he said about it at the time. Each is a case study; the rules they exercise are on [risk-and-cash](../methodology/risk-and-cash.md), [T2108](../methodology/t2108.md), [the two accounts](../methodology/pension-management.md) and the [market-state playbook](../playbooks/market-state.md). Notable calls with outcomes are tallied on [track-record](track-record.md); the year-by-year narrative is on the [timeline](timeline.md).
...
- [Risk & cash](../methodology/risk-and-cash.md) — the doctrine these episodes apply; the page they were split from
- [Track record](track-record.md) · [Timeline](timeline.md) · [Trend-flip log](trend-flip-log.md)
- [T2108](../methodology/t2108.md) · [The two accounts](../methodology/pension-management.md) · [The short side](../methodology/short-side.md)
