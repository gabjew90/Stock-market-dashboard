...
sources:
  ...
  - raw/posts/2010-05-17-china-in-free-fall-buying-fxp-qqqq-completes-8th-day-of-short-term-down-trend.md
...
**"Let's Talk Strategy" (2005-04-23):** his intellectual lineage — Darvas (buy at ATH, stop losses, great products), O'Neil (CANSLIM, small losses + big wins), Livermore (pilot buy, sit tight, average up), Weinstein (30-week MA, stage analysis), Neill (let the market speak). He states his core vow: never be long when his market trend indicators show a downtrend. Claimed 70%+ of stocks move with the index. ([WW 2005-04-23](../../raw/posts/2005-04-23-lets-talk-strategy.md))

**"About the General Market Index (GMI)" (2005-04-26):** introduces the [GMI](../methodology/gmi.md) with six components, each worth one point:
1. Successful 10-Day New High count > 100
2. ≥ 100 daily new highs in the universe
3. QQQQ daily trend positive
4. SPY daily trend positive
5. QQQQ weekly trend positive
6. IBD Mutual Fund Index above its 50-day MA
...
## December 2005 (30-day) — the cash-or-short rule stated
...
## January 2006 (cont.) — the GMI confirms, it does not predict; the leader tell; chickens survive
...
and writes the anomaly down rather than rescuing it. Four of five indexes in short-term up-trends near yearly
highs, yet Investors Intelligence had *fallen* to 45.3% bullish and 29.5% bearish from "more than 60% bullish in
early January when this rally began." His question: "**Do the newsletter writers actually become less bullish as
the market rises? I thought sentiment was typically a contrary indicator with people being most bullish at the
top, after a rise.**" No explanation offered; the technicals get backed instead — "I just hate to denigrate this
market when there appears to be so much agreement that it must decline, **even in the face of the considerable
technical evidence to the contrary**." The WPM isolates the laggard (only the QQQQ below its 30-day average, 49%
of its components above theirs against 60–68% elsewhere), and a MACD "very close to reversing" is read as
underlying strength on day 15 of a down-trend. Put/call "a relatively high .76" — the indicator in use twelve
years before the post that fixes its threshold. ([WW 2006-02-27](../../raw/posts/2006-02-27-gmi-5-the-rally-people-love-to-hate.md))
...
for years — "**I expanded the comparison of my indicators to include the IBD 100 stocks. I think it will provide
valuable insights into the market** to see how the highly rated IBD100 stocks' performance compares with my
universe of 4,000 stocks" — framed as a second breadth sample rather than as a scorecard for IBD. The first
finding is the one that reconciles his later, harsher audits: short-term the two groups were indistinguishable,
but **31% of his universe was above its 10-week average against 51% of the IBD 100, and 52% against 90% above
the 30-week**, with twice as many IBD names bouncing off the 10-week (29% vs 13%). "These differences… signify
that the **IBD 100 type of growth stocks are more likely to remain in longer term up trends**." Growth lists
...
**May 2007 — posting cadence changed; covered calls and QLD.** He drops daily posting in favour of posting "at a minimum whenever the GMI changes," justified on signal-to-noise grounds: "It is not necessary and is, perhaps, detrimental to take the pulse of the market too often." With the GMI at 6 since April 3, QLD returned +12.3% and beat 76% of Nasdaq 100 stocks — the earliest form of the leveraged-ETF-over-stock-picking argument he later restates with TQQQ. He also describes the **covered-call income strategy**: one-month calls on up-trending stocks he owns, spread thin, returning **2–4% per month** against 0.4% in a money-market fund. ([WW 2007-05-22](../../raw/posts/2007-05-22-gmi-6-no-longer-post-daily-but-when-gmi-changes-the-ideal-boomer-strategy-writing-covered-calls.md))

**August 2007 — the summer decline; thresholds stated; T2108 at 8%.** The clearest early statement of the operating rule: "I typically start to exit the long side of the market when the GMI falls below 4 and to buy once it climbs back above 3" — four years before the 2011 post that is usually cited for it. The GMI's 2007 record is given date by date: 6→1 at the February drop, below 4 until March 21, then 4–6 through July 24 while the market rose ~11%, then 3 on July 25 — "So, I have escaped the latest carnage." T2108 bottomed at **8%**. Also the autobiographical lesson: "I used to profit in the up-trend and give it all back and more in the subsequent decline. This is THE KEY to successful trading." ([WW 2007-08-20](../../raw/posts/2007-08-20-gmi-1-more-new-highs-than-lows-performance-of-gmi-strongest-ibd100-stocks.md))

**September 2007 — IBD100 survivorship bias; the 30-day average confirmed as a GMI input.** He audits his own candidate pool and finds IBD's published performance biased because "IBD continually drops poor performers from the index." Measuring the original lists instead: only ~half of each list's stocks were higher later, and the spread is explained entirely by *when* the list was published — 31% for the mid-July list (at the summer top) versus 82% for the 8/20 list (at the bottom). "**Even the fate of the IBD100 stocks is largely determined by the trend of the relevant market index.**" Leadership decays: after ~4 months an IBD100 list resembles the Nasdaq 100. The post also states plainly that "several closes below the 30 day would decrease the GMI" — direct evidence that the daily-trend components are 30-day-average tests. ([WW 2007-09-17](../../raw/posts/2007-09-17-gmi-5-ibd100-stocks-not-good-for-buy-and-hold.md))

**October 2007 — at the top, with everything still reading strong.** On October 1 the GMI was 6 and the QQQQ on Day 21; the IBD100 published 8/20 had beaten the Nasdaq 100 (median +15.6% vs +11%, with 42 of 100 up 20%+). ([WW 2007-10-01](../../raw/posts/2007-10-01-gmi-6-ibd100-stocks-do-outperform-meet-judy-a-great-stock-picker.md)) By October 29 — days after the top — the GMI had ticked to 4 as the Successful 10-Day New High component turned negative "barely," but **GMI-L stood at 94%**, GMI-R at 80%, and QQQQ/SPY had closed above their 10-week averages for seven weeks. Nothing in the long-term readings called the top. This post also carries a **looser threshold than he states elsewhere** — "I will trade long in the market as long as the GMI is greater than 2" — which conflicts with the "below 4" rule of two months earlier. ([WW 2007-10-29](../../raw/posts/2007-10-29-gmi-4-gmi-r-8-gmi-performance-judys-pick-cytr.md))
...
its *low* end — 0.41, near the 12-month low of 0.38 — "**a low p/c ratio suggests relatively fewer people bearish
enough to buy puts, a contrary indicator, often signaling impending market weakness**." The wiki's other put/call
citations are all high readings taken as bounce warnings; this is the same instrument at the opposite pole.
Component 6 stated in the negative, two years before the 2009 positive form: "**when these fund managers are not
doing well, I do not make money buying growth stocks**." And the short-side scaling rule, written while losing on
the position: "I know I took a loss last week on my prior QID purchases… **the prudent course for me is to make
small bets on the down-trend with close protective sell stops, in case the market moves up. If the down-trend
deepens, I will accumulate the inverse ETF on the weaker index**" — with Baruch in 1929 as the precedent for
paying repeated small losses to catch a major turn. GMI-S 25 across SPY/DIA/QQQQ/IJR corroborates the 16-test
construction. ([WW 2007-01-08](../../raw/posts/2007-01-08-gmi-1-gmi-s-25-ibd-100-underperform-down-trend-here.md))
...
## April 2009 (rhetoric) — 'the market needs to rest' is nonsense; QSII's three-year base

**"Market rally does not need a rest; QSII breaks out to an all-time high" (2009-04-19):** a named fallacy
answered with a base rate. "The media pundits claim the market needs to rest. The market gets tired and needs to
consolidate for a while — **such utter nonsense!**" The counter is the day count: the Dow up ~24% from the bottom
against ~100% snap-backs from the 1930s bottoms, and "the QQQQ is only in the 22nd day of its up-trend. **The
up-trend that ended July 27, 2007, lasted 80 days!**" The trade is QSII — "a 40 bagger from 1999-2006, then
formed a three year base," breaking to a new high on increased volume: "**when a stock breaks from a multi-year
base to an all-time high, I become interested**," with Darvas's supply argument attached — such stocks are ones
in which "**everyone who owned them had a profit**," so no trapped holders sell into the advance. T2108 at 92%,
"as high a reading as it ever gets… **only that it is rebounding from deeply oversold territory**." And the
scarcity read: no more than 15 new highs on any day that week, so "the fact that few stocks are at their 52 week
highs makes these winners stand out." ([WW 2009-04-19](../../raw/posts/2009-04-19-market-rally-does-not-need-a-rest-qsii-and-a-few-others-break-out-to-all-time-highs.md))
...
**"Jim Cramer on stop loss orders–terribly wrong again!" (2010-03-15):** comprehensive statement of stop-loss doctrine. Decides stop before buying; places GTC order immediately on fill; raises stops manually; never uses automatic trailing stops. 3X ETF tactic: small initial buy, average up if it moves in your favor. ([WW 2010-03-15](../../raw/posts/2010-03-15-jim-cramer-on-stop-loss-orders-terribly-wrong-again-kci-soars-how-i-trade-the-3x-etfs.md))

**"How I buy AAPL for 12% down without using margin" (2010-04-19):** deep in-the-money call options as a capital-efficient way to control the same number of shares without margin. Key discipline: do not use the leverage to buy more shares than you could have afforded outright. ([WW 2010-04-19](../../raw/posts/2010-04-19-how-i-buy-aapl-for-12-down-without-using-margin.md))

---

## February 2010 — the GMI explained for students; T2108 30/20; the daily Guppy turns bearish

**"Short term down-trend deepens; QQQQ Guppy chart ominous; In cash" (2010-02-01):** GMI construction for a new class (Nasdaq-100 focus, ≥100 new highs in ~4,000 stocks above $5, weekly QQQQ = longer term); T2108 30% beginning oversold, < 20% expect a rebound; the daily Guppy's short averages under the long for the first time since March 2009. ([WW 2010-02-01](../../raw/posts/2010-02-01-short-term-down-trend-deepens-qqqq-guppy-chart-ominous-in-cash.md))
...
## May 2010 (pension) — the pension trigger stated: weekly QQQQ index / Stage 4
...
## January 2011 (muni) — the municipal-bond alarm: new lows sorted by industry

**"The municipal bond collapse has begun — taking cover" (2011-01-18):** 116 new lows on an up day, almost all muni funds, in the 2008 bank pattern; TFI in a Stage 4 with institutional volume, BWR "more like what I call a submarine pattern"; "I act on what the market behavior tells me, not what people opine"; the GMI at maximum "only detect[s] a change in trend after it has occurred"; II bears 19.1%. ([WW 2011-01-18](../../raw/posts/2011-01-18-the-municipal-bond-collapse-has-begun-taking-cover.md))
...
**"GMI declines to 5, GMI-R to 7; getting cautious" (2011-02-23):** T2108 "acts like a pendulum… up-trends tend to end near 80% and down-trends below 20%"; "I tend to become cautious when the market indexes close below their 10 week averages or when the GMI declines to 3 or less… [or] when the market leaders… weaken"; "a lot of little losses and a few very large gains." ([WW 2011-02-23](../../raw/posts/2011-02-23-gmi-declines-to-5-gmi-r-to-7-getting-cautious.md))
...
## April 2013 (index GLBs) — SPY and DIA break their green lines; react, don't anticipate; GLD's failed GLB

**"Market in strong up-trend; Beware the bearish media pundits; Gold's 'sudden' decline" (2013-04-14):** SPY/DIA GLBs → "often followed by a multi-month rise… should stay above its green line… if it fails… a major reversal"; "not anticipate a change in trend, but to react after the signal is evident"; QQQ's 2000 green line ~119; GLD in a Stage 4 with a failed GLB and a new green line — "the time to buy… is when it first breaks above a green line top." ([WW 2013-04-14](../../raw/posts/2013-04-14-market-in-strong-up-trend-beware-the-bearish-media-pundits-golds-sudden-decline.md))
...
**"Technical strength of market continues to grow; FB green line break-out coming?" (2013-09-08):** "the market is usually right, opinions are often wrong"; Livermore 1940 on new listings touching "a brand new high" — "Livermore was describing my concept of a green line break-out"; FB: accumulate on a *close* above $45, hold while above; overhead supply from 2012's $40 buyers; AAPL's failed October-2012 GLB as the exit example. ([WW 2013-09-08](../../raw/posts/2013-09-08-technical-strength-of-market-continues-to-grow-fb-green-line-break-out-coming.md))
...
## July 2015 (limits) — 'one would have done well by buying when the GMI issued a Sell'

**"Schizoid Mr. Market" (2015-07-12):** the February limitation restated in its harder form. The red arrows
marking GMI Sell signals on his weekly QQQ chart "indicate that **during this bull market one would have done
well by buying stocks when the GMI issued a Sell**" — not that the Sells were early, but that fading them would
have paid. The defence is about tails, not hit rate ("over a long multi-year period **the GMI has kept me out of
bear markets**"), and the cost is absorbed by the account structure: "**I don't mind exiting with a GMI Sell and
going back in if the market rally resumes. This is a benefit of trading in a tax deferred IRA where I can go in
and out without any tax consequences.**" The whipsaw is affordable because of *where* he trades — a qualification
that does not transfer to a taxable account. Technicals: the QQQ back above its 30-week average, "the 4th time
...
## December 2016 (cont.) — ~40% of down-trends end under 5 days; SPY/QQQ weekly divergence
...
## February 2017 (scan) — a first-day breakout scan, run in the last hour

**"New TC2000 Scan finds GLB and possible cup with handle break-out $PJC" (2017-02-12):** a 100-day high that was not one the prior day, up strongly from a year ago, above-average volume — 19 hits; "I like to run this scan during the last hour of the trading day (I do not want a stock that breaks out early only to reverse by the end of the day)"; scans as "a *starting point*". ([WW 2017-02-12](../../raw/posts/2017-02-12-new-tc2000-scan-finds-glb-and-possible-cup-with-handle-break-out-pjc-next-post-tuesday-night.md))
...
## February 2018 (thresholds) — put/call 1.2, stochastic .20, and the monthly top in three stages

**"Bloody Monday open likely — In cash during this mini-decline" (2018-02-04):** unusually specific about
numbers. The put/call rule: at 0.97, "**option players are not scared enough yet. When the ratio reaches 1.2 or
higher we will be near a bounce.**" The stochastic rule: the QQQ daily 10.4 at 0.47, against "**the market
indexes usually bounce around .20 or less**" — both used to argue against buying the decline yet. The monthly
GMMA top template broken into ordered stages off SPY's 2000 and 2007 tops: "a major decline begins with the index
**closing below all of the red line shorter averages. Then the red lines turn down and converge with the blue
lines. This pattern takes several months to develop.** The RWB pattern then dissolves and the red lines move
below the blue lines." Three checkpoints, not one; February 2018 had not cleared the first. The pension trigger
with both its conditions: "**I tend to exit the market in my pension accounts when the index closes below its 30
week average *and the average begins to turn down***." And the weekend mechanism — "bloody Fridays often lead to
...
**"TC2000 alerted me to a high volume GLB" (2020-07-23):** "TC2000 sent me a text yesterday immediately when AMD crossed the green line. I had created the alert on June 19" — the GLB alert set five weeks in advance. ([WW 2020-07-23](../../raw/posts/2020-07-23-blog-post-tc2000-alerted-me-to-a-high-volume-glb-yesterday-amd-learn-how-to-set-glb-alerts.md))
...
## May 2021 (GLB) — the 3-monthly-bar drawing rule and the IPO exception

**"GLB (green line break-out) explained" (2021-05-31):** "a green line can only be drawn after 3 months (3 monthly bars) have passed since a peak price bar that has not been surpassed"; IPO exception (a few weeks); "a failed set-up on which I base my purchase must always be sold"; above-average weekly volume preferred; PGNY +75% from its GLB. ([WW 2021-05-31](../../raw/posts/2021-05-31-blog-post-glb-green-line-break-out-explained-some-stocks-having-a-glb-last-week-mec-omp-tgls-flng-cubi.md))
...
## July 2021 (black dot) — the formula published; the oversold claim

**"32nd day of $QQQ short term up-trend; Key to success…" (2021-07-12):** the black dot's logic given in full (10.1 stochastic ≤ 25 within 3 days; up on the day; above the 30-day SMA or 21-day EMA; dot at the 5-day low) and the claim beneath it — "almost every significant rise in a stock begins from an oversold level. But not every oversold level leads to a big rise" — which is why the ATH filter exists. ([WW 2021-07-12](../../raw/posts/2021-07-12-blog-post-32nd-day-of-qqq-short-term-up-trend-key-to-success-in-market-is-to-have-an-objective-defined-set-up.md))

## July 2021 (measure) — TQQQ +23.3% from U-1; the needle-in-the-haystack question

**"GMI is at 6 (of 6)… the $QQQ short term trend count is U-27" (2021-07-05):** buy TQQQ on U-1 and accumulate as the trend persists; since U-1, TQQQ +23.3% vs 4% of Nasdaq-100, 1% of S&P 500, 0% of Dow 30 and 6% of all US stocks ahead of it; "are you trying to find the needle in the haystack rare stock… or are you interested in a higher probability approach?" ([WW 2021-07-05](../../raw/posts/2021-07-05-blog-post-gmi-is-at-6-of-6-and-up-trends-remain-intact-the-qqq-short-term-trend-count-is-u-27-my-profitable-s.md))
...
## August 2021 (definition) — what a set-up is

**"$NKE — an example…" (2021-08-22):** "the key to prospering in the market is to have developed a set-up, defined by **objective conditions** which leads one to expect that a stock will rise almost immediately. **The set-up must also suggest a price at which to set a stop loss**… a lot of small losses and a few big winners"; worked on NKE with a GTC stop at 164.67 under the bounce. ([WW 2021-08-22](../../raw/posts/2021-08-22-blog-post-stocks-rally-and-2-day-old-qqq-short-term-down-trend-may-end-monday-nke-an-example-of-how-i-use-my.md))
...
## July 2022 (drawing) — where the green line goes on the chart

**"Friday could be first day of new $QQQ short term up-trend" (2022-07-07):** a reader question on HALO settles the convention — "I drew it at the top of the highest monthly bar even though the stock retreated from the high that month," not at a later lower peak; plus a higher-low structure read inside the down-trend. ([WW 2022-07-07](../../raw/posts/2022-07-07-blog-post-friday-could-be-first-day-of-new-qqq-short-term-up-trend-why-this-qqq-rally-may-be-different-how-i.md))
...
## September 2022 (bottom) — the 10-week crossing above the 30-week; evaluating INSW

**"Weekly chart of $DIA suggests re-test" (2022-09-15):** how to discern a bottom — "the 10 week average turns around and climbs above the 30 week average. Once that happened one had 1.6 years to ride the up-trend"; "sitting is the hard part," per Livermore. ([WW 2022-09-15](../../raw/posts/2022-09-15-blog-post-day-13-of-qqq-short-term-down-trend-weekly-chart-of-dia-suggests-re-test-of-last-junes-lows-how-to.md))

**"$INSW is one of 4 stocks at ATH" (2022-09-19):** a teaching walk-through of evaluating a stock surfaced by technicals — GLB, a close below the green line, a retake, a new ATH on the heaviest volume since April, support at the 8-EMA above the 21 — then MarketSmith fundamentals (composite 98, Acc/Dis A+, group RS 98). ([WW 2022-09-19](../../raw/posts/2022-09-19-blog-post-35-us-new-highs-and-438-new-lows-4-stocks-at-ath-one-of-them-is-insw-see-daily-chart-of-insw-and-ho.md))

## October 2022 — the <5%-below-a-recent-ATH column scan

**"See my new way to scan for stocks near their recent ATH" (2022-10-03):** O'Neil's greatest winners based at or near their ATHs; a TC2000 column combining monthly Price New High (500-bar high within 3 bars ≈ 41 years) with the daily `h > .95*maxh60`, plus C > 30 and V > 10000 — catching completed GLBs and pre-breakout candidates alike. ([WW 2022-10-03](../../raw/posts/2022-10-03-blog-post-day-25-of-qqq-short-term-down-trend-see-my-new-way-to-scan-for-stocks-near-their-recent-ath-and-glb.md))
...
## January–March 2023 (pattern) — '4wk>10wk>30wk, my prime pattern'; the green bar scan in one line

**"Two stocks that came up in my TC2000 weekly green bar scan" (2023-01-25):** "all had 4wk>10wk>30wk averages, **my prime pattern for advancing stocks**," a weekly green bar (bounce off the 4-week), and the GLB → consolidation → second-breakout shape; "stocks at new ATHs after a market decline are often the new leaders." ([WW 2023-01-25](../../raw/posts/2023-01-25-blog-post-two-stocks-that-came-up-in-my-tc2000-weekly-green-bar-scan-for-stocks-at-ath-with-20-week-high-in-r.md))

**"Day 1 of new $QQQ short term up-trend" (2023-03-06):** the spec in one line — "green bar scan = ATH in past 3 months, rising pattern of 4wk>10wk>30wk, currently bouncing rising 4wk avg and RS at 20 week high." ([WW 2023-03-06](../../raw/posts/2023-03-06-blog-post-day-1-of-new-qqq-short-term-up-trend-will-powell-kill-it-137-new-us-highs-100-lows-and-41-at-ath-6.md))
...
## February 2023 (scan) — 20-week RS high + recent ATH + a 4-week bounce, stop at the green bar's low

**"Only 70 US stocks at new highs" (2023-02-12):** "one of my favorite scans… a stock in a strong up-trend, at a 20 week high in relative strength vs. SPY, that reached an ATH in the past 3 months and that has bounced up off of its rising 4 week average"; sell stop at the bottom of the weekly green bar; 29 of ~7,000, ranked by close ÷ 250-day low. ([WW 2023-02-12](../../raw/posts/2023-02-12-blog-post-day-21-of-qqq-short-term-up-trend-only-70-us-stocks-at-new-highs-and-63-at-new-lows-on-friday-11-at.md))
...
## April 2025 (cont.) — SQQQ as the mirror of TQQQ; wait for the bottom to define itself

**"If one had bought $SQQQ on Day 1 of the down-trend…" (2025-04-20):** "SQQQ beats almost all individual stocks in a sustained down-trend. The key is to buy on Day 1 and hold, but to sell quickly if the trend reverses"; "stop trying to predict a bottom and wait for it to define itself"; re-entry need only precede the level you exited at; age decides whether a decline can be ridden; ATH-only selection, fallen leaders excluded. ([WW 2025-04-20](../../raw/posts/2025-04-20-blog-post-day-38-of-qqq-short-term-down-trend-if-one-had-bought-sqqq-on-day-1-of-the-down-trend-it-would-now.md))
...
## July 2025 (TraderLion) — the 8-EMA bounce scan

**"Had a wonderful TraderLion conference talk" (2025-07-27):** GLB, Blue Dot and the daily 8 EMA presented on Day 6; the scan shown — recent ATH plus a bounce off the tracked daily 8 EMA, 26 of 6,200, ranked by 250-day change. ([WW 2025-07-27](../../raw/posts/2025-07-27-blog-post-day-63-of-qqq-short-term-up-trend-had-a-wonderful-talk-with-richard-at-traderlion-annual-conference.md))
...
## October 2025 (critique) — set-up collections are survivorship bias

**"Thank you for the many 'likes'…" (2025-10-05):** "anyone can show us collections of *winning* stocks… **just buying every Friday could have yielded profits on a steadily rising stock**… these collections do not show us the number of times that each setup fails, especially in a declining market!" Every collection should include failures; most traders report ≥50% of trades failing. RDDT's failed GLB walked through. ([WW 2025-10-05](../../raw/posts/2025-10-05-blog-post-day-29-of-qqq-short-term-up-trend-thank-you-for-the-many-likes-i-received-for-my-post-about-the-pun.md))
...
## June 2026 — how the 2000 top was identified: the 30-week, then and now

**"How I identified and exited at the market top in 2000" (2026-06-01):** the 2000 chart beside the current one — "**this signal helped me to get out at the beginning of all major declines since 2000**… Thank you Stan Weinstein for teaching me stage analysis"; and the latest application: "I got defensive in April 2025 until the 30 week resumed its rise." ([WW 2026-06-01](../../raw/posts/2026-06-01-how-i-identified-and-exited-at-the-market-top-in-2000-when-the-30-week-average-curved-down-to-identify-a-like.md))
...
- [WW 2017-09-04 — BGNE trade setup example](../../raw/posts/2017-09-04-bgne-example-of-a-stock-purchase-set-up-for-my-new-students-gmi-green.md) ([summary](../sources/2017-09-04-bgne-example-of-a-stock-purchase-set-up-for-my-new-students-gmi-green.md))
...
- [WW 2020-03-15 — Livermore: Amputation without anaesthetics; 2020 exit](../../raw/posts/2020-03-15-livermore-amputation-without-anaesthetics-after-avoiding-the-2000-decline-i-began-this-blog-in-2006-to-help-p.md) ([summary](../sources/2020-03-15-livermore-amputation-without-anaesthetics-after-avoiding-the-2000-decline-i-began-this-blog-in-2006-to-help-p.md))
- [WW 2021-01-24 — GLB origin; overhead supply; 6 examples](../../raw/posts/2021-01-24-blog-post-in-the-60s-i-used-to-receive-a-book-containing-monthly-charts-of-stocks-i-noticed-that-stocks-that.md) ([summary](../sources/2021-01-24-blog-post-in-the-60s-i-used-to-receive-a-book-containing-monthly-charts-of-stocks-i-noticed-that-stocks-that.md))
...
- [WW 2007-05-22 — Covered calls as the boomer strategy; QLD over stock-picking](../../raw/posts/2007-05-22-gmi-6-no-longer-post-daily-but-when-gmi-changes-the-ideal-boomer-strategy-writing-covered-calls.md) ([summary](../sources/2007-05-22-gmi-6-no-longer-post-daily-but-when-gmi-changes-the-ideal-boomer-strategy-writing-covered-calls.md))
- [WW 2007-08-20 — GMI performance through the 2007 declines; exit/re-entry thresholds](../../raw/posts/2007-08-20-gmi-1-more-new-highs-than-lows-performance-of-gmi-strongest-ibd100-stocks.md) ([summary](../sources/2007-08-20-gmi-1-more-new-highs-than-lows-performance-of-gmi-strongest-ibd100-stocks.md))
- [WW 2007-09-17 — IBD100 survivorship bias; even leaders follow the index trend](../../raw/posts/2007-09-17-gmi-5-ibd100-stocks-not-good-for-buy-and-hold.md) ([summary](../sources/2007-09-17-gmi-5-ibd100-stocks-not-good-for-buy-and-hold.md))
...
- [WW 2010-05-17 — China in free-fall, buying FXP; QQQQ completes 8th day of down-trend](../../raw/posts/2010-05-17-china-in-free-fall-buying-fxp-qqqq-completes-8th-day-of-short-term-down-trend.md) ([summary](../sources/2010-05-17-china-in-free-fall-buying-fxp-qqqq-completes-8th-day-of-short-term-down-trend.md))
...
- [WW 2006-02-27 — gmi-5-the-rally-people-love-to-hate](../../raw/posts/2006-02-27-gmi-5-the-rally-people-love-to-hate.md) ([summary](../sources/2006-02-27-gmi-5-the-rally-people-love-to-hate.md))
- [WW 2006-05-30 — gmi-0-ibd-100-stocks-stronger-some-shorts-ocean-city-had-light-traffic](../../raw/posts/2006-05-30-gmi-0-ibd-100-stocks-stronger-some-shorts-ocean-city-had-light-traffic.md) ([summary](../sources/2006-05-30-gmi-0-ibd-100-stocks-stronger-some-shorts-ocean-city-had-light-traffic.md))
- [WW 2007-01-08 — gmi-1-gmi-s-25-ibd-100-underperform-down-trend-here](../../raw/posts/2007-01-08-gmi-1-gmi-s-25-ibd-100-underperform-down-trend-here.md) ([summary](../sources/2007-01-08-gmi-1-gmi-s-25-ibd-100-underperform-down-trend-here.md))
