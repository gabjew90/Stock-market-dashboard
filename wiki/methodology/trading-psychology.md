...
Dr. Wish writes about emotion the way he writes about indicators: as something to be observed, distrusted, and put under a rule. This page collects the rules — each stated by him, several with the failure that prompted it. The *design* principle behind them (detachment is engineered by the stop, not willed) is on [trading philosophy](trading-philosophy.md#emotional-detachment-is-engineered-not-willed); this page is the operating set. Where a rule below is also a mechanical procedure, the playbook holds the procedure and this page holds the reason.

## 1. When gut and instruments disagree, the instruments win
...
**Selling too soon, defended.** In January 2022, cutting the pension to ~20% invested: Rothschild — "I never buy at the bottom and I always sell too soon"; Baruch — "I made my money by *selling too soon*"; Livermore — "Never buy at the bottom, and *always sell too soon*." "So I guess I am in good company… And I may be selling too soon……" He names the reason plainly: "I know I am more of a chicken now because **I need to conserve my funds for retirement**." ([WW 2022-01-09](../../raw/posts/2022-01-09-blog-post-the-weekly-charts-of-qqq-dia-and-spy-show-each-having-three-heavy-volume-down-weeks-suggesting-dist.md)) The 2025 form: "**I prefer to sell early and not get caught up in the panic selling near the bottom.**" ([WW 2025-03-06](../../raw/posts/2025-03-06-blog-post-day-8-of-qqq-short-term-down-trend-28-us-new-highs-81-lows-and-5-at-ath-i-will-resist-the-inevitabl.md))
...
- [Trading philosophy — the five propositions](trading-philosophy.md) — the reasoning; the "detachment is engineered" section
- [Risk & cash](risk-and-cash.md) · [The two accounts](pension-management.md) · [Exits](../playbooks/exits.md)
- [Defensive episodes](../history/defensive-episodes.md) — the August 2011 exit in full
...
- [WW 2011-08-15 — 100% cash in trading accounts and university pension; the addiction line](../../raw/posts/2011-08-15-100-cash-in-trading-accounts-and-university-pension.md) ([summary](../sources/2011-08-15-100-cash-in-trading-accounts-and-university-pension.md))
- [WW 2013-10-13 — Baltimore AAII meeting; sleeping point](../../raw/posts/2013-10-13-saturdays-baltimore-aaii-meeting-gld-in-stage-4-all-gmi-components-positive-but-i-am-waiting.md) ([summary](../sources/2013-10-13-saturdays-baltimore-aaii-meeting-gld-in-stage-4-all-gmi-components-positive-but-i-am-waiting.md))
