...
Dr. Wish's signature setup: buying a stock as it breaks above an all-time-high price level that has held for at least three months. The "green line" is a horizontal line drawn at that all-time-high level on a monthly chart.

## What it is

A green line is drawn on a **monthly** price chart at the level of a stock's all-time high, once the stock has stayed below that high for **3 or more months**. This base-formation period means real resistance was established at that price level.

When the stock later **breaks above the green line** — appearing on the new-high list — that is the Green Line Breakout entry signal. ([WW 2012-07-23](../../raw/posts/2012-07-23-24th-day-of-qqq-short-term-up-trend-stage-analysis-and-green-line-charts.md))

Dr. Wish illustrated this with Microsoft's 1990–2000 run: MSFT formed multiple multi-month bases and broke to new all-time highs repeatedly. Anyone who refused to buy after each green-line base because the stock was "already at a high" missed enormous gains. After MSFT topped in 2000, it stopped forming GLBs. His view: when MSFT eventually closes above its 2000 high, he would become interested again. ([WW 2012-07-23](../../raw/posts/2012-07-23-24th-day-of-qqq-short-term-up-trend-stage-analysis-and-green-line-charts.md))

### The base-and-breakout logic (precursor, 2005)
...
**Index GLBs and the failed-GLB rule (2013).** SPY and DIA through their green-line tops in April 2013: "when a stock or index does this, it often is followed by a multi-month rise… the index or stock should stay above its green line level. If it fails, like GLD and AAPL did a while ago, then I would expect a major reversal of the up-trend." GLD's failed July-2012 GLB left it in a Stage 4 with a *new* green line — "the time to buy a stock or ETF is when it first breaks *above* a green line top." ([WW 2013-04-14](../../raw/posts/2013-04-14-market-in-strong-up-trend-beware-the-bearish-media-pundits-golds-sudden-decline.md)) And in weak markets GLBs consolidate rather than fail — BABY hugging its rising 10-week, AAPL coming through the October 2014 turbulence at an ATH. ([WW 2014-10-26](../../raw/posts/2014-10-26-qqq-short-term-trend-turns-up-retakes-30-week-average-glb-stocks-shine-aaplbabyagiorglsregn.md))
...
**5-day EMA post-GLB exit rule (2026):** The newest exit technique for managing a GLB position during an advance: track the stock against its 5-day exponential moving average. Hold while the stock closes above the 5-day EMA; place a sell stop below the low of the day it closes beneath the 5-day EMA. INTC and QQQ are the worked examples from May 2026. "It is amazing how well GLBs have been working!" ([WW 2026-05-10](../../raw/posts/2026-05-10-bog-post-day-22-of-qqq-short-term-up-trend-qqq-10-wk-avg-now-closes-week-above-30-wk-avg-gmigreen-glb-breakou.md))
