...
The [Green Line Breakout](green-line-breakouts.md) page defines the setup and its rules. This page carries the *evidence*: the worked cases he published, the failures he wrote up, the missed breakouts he confessed to, and the refinements each one produced. Read it when you want to know how the rule behaves in contact with a real chart rather than what the rule says. The definition, the drawing convention, the entry and the exit are all on [green-line-breakouts](green-line-breakouts.md); the entry procedure is the [GLB playbook](../playbooks/buying-glb.md).
...
- [Green Line Breakouts](green-line-breakouts.md) — the definition, drawing convention, entry and exit; the page this was split from
- [Playbook — buying a GLB](../playbooks/buying-glb.md) — the entry checklist
- [The oversold bounce](oversold-bounce.md) — the entry he prefers to the breakout, and why
- [Trading philosophy](trading-philosophy.md#your-own-hit-rate-is-an-indicator) — his own warning that worked examples are selected
