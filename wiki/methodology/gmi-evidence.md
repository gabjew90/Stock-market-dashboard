...
The [GMI's](gmi.md) six components were defined in prose once, in 2005, and thereafter published only as a daily table — which since about 2010 is an *image*, invisible to text search. This page is the provenance trail: the verbatim component labels read off tables from 2007, 2013, 2020 and 2026; the historical track-record chart he published in 2005; the signal record he tallied himself in 2013; a per-signal audit from 2016; and why the modern era is an image problem. Read it when you need to know *how sure* the wiki is about a component, not what the component is — that lives on [gmi.md](gmi.md), and the companion indexes are on [gmi-family](gmi-family.md).
...
- [The GMI family](gmi-family.md) — GMI-S, GMI-L, GMI-R, GMI2 and the rest of the table
- [Backtest — the timing overlay](backtest-timing-overlay.md) — what the reconstructed GMI does as a trading rule
- [Track record](../history/track-record.md) · [Trend-flip log](../history/trend-flip-log.md)
