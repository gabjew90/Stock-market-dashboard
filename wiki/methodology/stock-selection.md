...
How Dr. Wish narrows the universe to buy candidates: technical strength first, a basic fundamental check, and the RWB chart pattern as the visual filter.

## The core principle: buy launched rockets
...
A scan Dr. Wish ran in 2005 looked for stocks that had: doubled in the past year, had good recent earnings, and were near their all-time highs. He also looked at MoneyStream (a TC2005 proprietary indicator similar to on-balance volume) at 100% — indicating sustained institutional accumulation. ([WW 2005-06-05](../../raw/posts/2005-06-05-gmi-back-to-5-some-potential-winners-on-moving-averages.md))

By 2010 he had refined the workflow into a multi-step funnel ([WW 2010-02-22](../../raw/posts/2010-02-22-how-to-use-ibd-100-and-new-america-stocks-and-tc2007-to-find-potential-rocket-stocks-market-rally-begun.md)):

1. Sort the universe of ~4,000 actively traded stocks by whether they hit a new 52-week high that day.
2. Pull up the monthly chart for each and look for those at or near their 10-year all-time high.
3. Flag stocks with quarterly earnings ≥ 30% OR revenue growth ≥ 12% in the most recent quarter.
4. Cross-reference with the IBD 100 / IBD New America lists. In one documented run of this process, 68% of the surviving candidates had independently appeared on an IBD list — confirming the two filters agree more often than not.
...
Once a candidate passes the screen, Dr. Wish checks the **weekly GMMA (Guppy Multiple Moving Average) chart** for the Red White Blue (RWB) pattern. This was coined in September 2010 ([WW 2010-09-27](../../raw/posts/2010-09-27-introducing-red-white-and-blue-rwb-stocks-the-pattern-of-rockets.md)):

- **Red lines** = the shorter-term moving averages on the weekly GMMA
- **Blue lines** = the longer-term moving averages on the weekly GMMA
- **RWB** = red above blue, both rising, with **white space** between them. The white space is what distinguishes a genuine rocket from a struggling stock.
- **BWR** (the opposite) = shorter-term below longer-term = "submarine stock" — avoid.

He urges: "I urge my students to paste copies of these stocks to their computer monitors and to compare all potential purchases to them. Accept no less!" ([WW 2010-09-27](../../raw/posts/2010-09-27-introducing-red-white-and-blue-rwb-stocks-the-pattern-of-rockets.md))
