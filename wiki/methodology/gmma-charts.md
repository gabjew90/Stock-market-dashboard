...
Dr. Wish's adapted Guppy Multiple Moving Average chart — six short EMAs in red, six long in blue, a 13th of length 1 for the close — is the visual on which his trend reading runs at every timescale: **RWB** (red above blue with white space between) is the pattern of rockets and of healthy indexes, **BWR** is the pattern of submarines and market tops, and the same chart at weekly, daily, hourly, 5-minute and monthly resolution gives him a ladder from *is this a bull* down to *where inside the trend am I*. This page holds the chart itself: its construction and history (first drawn on the blog in May 2009, named RWB in September 2010, periods stated in 2014), the reading rules at each layer, the daily RWB system's entry and exit lines, and the monthly and hourly layers. The **rules** built on single moving averages — the 30-week Stage anchor, the 30-day short-term line, the 10-week holding rule, the 4/10/30 alignment, the stochastic overlay — stay on [moving-average-rules](moving-average-rules.md).
...
- [Moving-average rules](moving-average-rules.md) — the single-average rules (30-week, 30-day, 10-week, 4/10/30, stochastic); the page this was split from
- [Exits](../playbooks/exits.md#which-trailing-system-when) — the daily RWB exit against the weekly rules
- [Stock selection](stock-selection.md) — RWB as the rocket filter · [The short side](short-side.md) — BWR as the submarine pattern
- [Glossary](glossary.md) — RWB, BWR, GMMA, RLC, yellowband
