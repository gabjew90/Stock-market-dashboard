...
Dr. Wish runs money at two speeds. The **trading IRA** follows the daily signals — GMI, QQQ short-term count, stops — and is what "I am in cash" usually refers to. The **university pension** (mutual funds, later index funds) is steered off the *weekly* trend, exits in stages rather than on a day's reading, and since 2015 deliberately ignores GMI Sell signals. This page collects everything he has said about the slow account: the split itself, the staged exit protocol, the administrative constraints that shape it, and his rebuttals of the standard arguments against timing it at all. The trading-account doctrine — when to be in cash, stops, cutting losses — stays on [risk-and-cash](risk-and-cash.md); the day-to-day decision procedure is the [market-state playbook](../playbooks/market-state.md).

## University pension vs trading IRA
...
The two speeds visibly diverging, March 2016: "With the GMI on a buy, IBD on a confirmed up-trend and my QQQ short term up-trend in its 10th day, **I have been tip-toeing back into this market in my trading IRA. However, the longer term trend is not up, so I am not ready to reinvest my university pension funds.**" ([WW 2016-03-06](../../raw/posts/2016-03-06-13-recent-glb-stocks-to-monitor-algnbmscinfcnslcprtellimonlsnpnraswhcsyytfxtxrhvsto.md))
...
Two earlier statements of the trigger. May 2010, GMI 1 with only the weekly QQQQ component positive: "if that should turn negative, making the GMI and GMI-R register zero, I will consider moving my university pension funds from mutual funds to money market funds. I typically, however, like to see a Stage 4 down-trend begin before I do that." ([WW 2010-05-17](../../raw/posts/2010-05-17-china-in-free-fall-buying-fxp-qqqq-completes-8th-day-of-short-term-down-trend.md)) April 2014, on a GMI Sell with the QQQ's first weekly close under its 30-week: the 401(k) stays 100% invested "because of strict trading limits imposed by the fund group… if the QQQ closes several weeks below its 30 week average I will reluctantly consider transferring some" — and would use a rally back to ~89 to do it. ([WW 2014-04-13](../../raw/posts/2014-04-13-15th-day-of-qqq-short-term-down-trend-100-in-cash-head-and-shoulders-top-to-form.md))

**The trigger revised in practice (April 2022).** The protocol above describes what he had done historically; in April 2022 he says so in the past tense and notes he had departed from it: "**In the past when I took more chances I would wait for the 30 week average to curve down before taking my conservative university pension money out of the market.** We have reached that point now with QQQ, DIA, IWM, and maybe SPY. **However, as I wrote last November, I began to transfer my university pension money out then because of the technical weakness I saw in the market.**" So the November 2021 breadth-divergence exit moved the pension *five months before* the formal 30-week trigger fired — the clearest case of the discretionary overlay overriding the written rule, and in the opposite direction to the [2014 breach](trading-psychology.md#3-fear-will-make-you-break-your-own-rule--he-did-and-said-so). Re-entry is unchanged: "**I will reenter when the 30 week averages start rising again.**" ([WW 2022-04-06](../../raw/posts/2022-04-06-blog-post-jesse-livermore-said-finally-there-came-the-awful-day-of-reckoning-for-the-bulls-and-the-optimists.md))

On the horizon question he gives the recovery time as **26 years** here — "after the 1929 debacle, it took 26 years for the DOW to come back to its pre-crash level" — and as 25 years in April 2025; his own figure varies, and the point in both is that age decides whether a decline can be ridden.
...
- [Market-state playbook](../playbooks/market-state.md) — Step 0 (which account) and Step 5 (the staged exit)
- [GMI](gmi.md#a-limitation-he-published-himself-2015) — the 2015 demotion of GMI Sell signals for pension money
- [Moving-average rules](moving-average-rules.md) — the 30-week average the pension is steered by
- [Backtest — the timing overlay](backtest-timing-overlay.md) — tests the trading rule as if it were the pension rule
