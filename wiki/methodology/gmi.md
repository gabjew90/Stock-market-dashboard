...
How confident each of these six is, and the verbatim labels read off his published tables in 2007, 2013, 2020 and 2026, are on [GMI evidence](gmi-evidence.md#the-published-table--verbatim-component-labels-2007-2013-2020-2026).
...
On 2026-08-18 this page was split so that it holds only the index itself:

- **[The GMI family](gmi-family.md)** — GMI-S, GMI-L, GMI-R, GMI2, the 2007 threshold variation, the April 2008 dashboard, and the other columns of the daily table.
- **[GMI evidence](gmi-evidence.md)** — the verbatim table labels (2007/2013/2020/2026), the 2005 track-record chart, the 2013 signal record, the 2016 per-signal audit, and why the modern era is an image problem.
...
- [The GMI family](gmi-family.md) · [GMI evidence](gmi-evidence.md) · [Backtest — the timing overlay](backtest-timing-overlay.md)
